...
int main()
{
    ...
    tpizza pizzas[3];
    tpedido pedidos[6];
    int icl=0, ipi=0, ipe=0, pedidosdespachados=0, pedidosentregues=0, entregadores = {(1, 2, 3), (0, 0, 0)};
    int opcao=100;
    while (opcao != 0) {
        mostralinhas();
        printf("Seja bem vindo ao menu da pizzaria CATCH THE PIZZA, escolha uma das seguintes opcoes: \n1. Cadastrar clientes\n2. Cadastrar pizza\n3. Cadastrar pedido\n4. Despachar pizza\n5. Receber pizza\n6. Mostrar todas as pizzas entregues\n0. Sair do programa\nOpcao = ");
        mostralinhas();
        scanf("%d", &opcao);
        getchar();
