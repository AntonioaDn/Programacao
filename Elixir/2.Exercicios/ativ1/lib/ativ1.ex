defmodule Ativ1 do
  ...
  # função, consulte o arquivo ativ2_test.exs no diretorio 'test'
    ...
    def centraliza(str, largura) do
      espacos = largura - String.length(str)
      espacos_direita = Integer.floor_div(espacos, 2)
      espacos_esquerda = espacos - espacos_direita
      String.duplicate(" ", espacos_esquerda) <> str <> String.duplicate(" ", espacos_direita)
    end
